...
import { NeoCard, NeoButton, NeoInput, NeoSelect, NeoBadge, NeoDialog, NeoDatePicker, NeoConfirmDialog } from '../components/NeoUI';
import { Transaction, TransactionType, CategoryState, Asset, User } from '../types';
import { Plus, Search, ArrowUpRight, ArrowDownLeft, RefreshCw, Calendar, Tag, Wallet, Trash2, Edit, Save, X as CloseIcon, Download, Sparkles, Loader2, History, User as UserIcon } from 'lucide-react';
      ...
      >
          <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
                ...
                <div className="space-y-1">
                    ...
                    {formData.type === 'EXPENSE' && formData.accountId && (
                        <div className="text-[10px] text-right font-bold text-gray-500">
                            Available: {formatCurrency(assets.find(a => a.id === formData.accountId)?.value || 0)}
                        </div>
                    )}
                </div>
             ...
             <div className="flex gap-2 mt-4">
               <NeoButton type="submit" className="w-full">{t.transactions.save}</NeoButton>
